	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'      => '',
				'selectors' => [
					'{{WRAPPER}} .bew-account-form-register form.woocommerce-form-register .form-row label' => 'text-align: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'type' => Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bew-account-form-register button' => 'border-color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
