...
class Module extends Module_Base {
	...
	public function replace_go_pro_custom_css_controls( $controls_stack ) {
		...
		$controls_stack->add_control(
			...
			[
				'raw' => esc_html__( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'elementor-pro' ),
				'type' => Controls_Manager::RAW_HTML,
