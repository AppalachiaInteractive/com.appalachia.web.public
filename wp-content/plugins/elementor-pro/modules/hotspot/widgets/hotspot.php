	...
	protected function register_controls() {
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}}' =>
							'{{hotspot_horizontal.VALUE}}: {{SIZE}}{{UNIT}}; --hotspot-translate-x: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}}' =>
							'{{hotspot_vertical.VALUE}}: {{SIZE}}{{UNIT}}; --hotspot-translate-y: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Custom Tooltip Position', 'elementor-pro' ),
