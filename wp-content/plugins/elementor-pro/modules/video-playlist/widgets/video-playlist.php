...
class Video_Playlist extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				'name' => 'image_overlay_size', // Usage: `{name}_size` and `{name}_custom_dimension`, in this case `image_overlay_size` and `image_overlay_custom_dimension`.
				'default' => 'full',
				'separator' => 'none',
				'condition' => [
					'show_image_overlay' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Videos Amount', 'elementor-pro' ),
				'type' => Controls_Manager::HEADING,
			]
		);
					...
					<div class="e-tabs-header">
						...
						<div class="e-tabs-header-right-side">
							<?php if ( $playlist_object->is_show_video_count ) : ?>
								<span class="e-tabs-videos-count"><?php echo $playlist_object->video_count; ?> <?php echo esc_html__( 'Videos', 'elementor-pro' ); ?></span>
							<?php endif; ?>
