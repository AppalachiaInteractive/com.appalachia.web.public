		...
		$settings->add_section( Settings::TAB_INTEGRATIONS, 'activecampign', [
			...
			'fields' => [
				...
				self::OPTION_NAME_API_URL => [
					...
					'field_args' => [
						'type' => 'url',
						'desc' => sprintf( esc_html__( 'To integrate with our forms you need an <a href="%s" target="_blank">API Key</a>.', 'elementor-pro' ), 'https://help.activecampaign.com/hc/en-us/articles/207317590-Getting-started-with-the-API' ),
					],
				],
				'validate_api_data' => [
					'field_args' => [
