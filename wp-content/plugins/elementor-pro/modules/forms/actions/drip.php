		...
		$settings->add_section( Settings::TAB_INTEGRATIONS, 'drip', [
			...
			'fields' => [
				self::OPTION_NAME_API_KEY => [
					...
					'field_args' => [
						'type' => 'text',
						'desc' => sprintf( esc_html__( 'To integrate with our forms you need an <a href="%s" target="_blank">API Key</a>.', 'elementor-pro' ), 'http://kb.getdrip.com/general/where-can-i-find-my-api-token/' ),
					],
				],
				'validate_api_data' => [
					'field_args' => [
