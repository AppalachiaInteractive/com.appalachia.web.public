		...
		$settings->add_section( Settings::TAB_INTEGRATIONS, 'mailerlite', [
			...
			'fields' => [
				self::OPTION_NAME_API_KEY => [
					...
					'field_args' => [
						'type' => 'text',
						'desc' => sprintf( esc_html__( 'To integrate with our forms you need an <a href="%s" target="_blank">API Key</a>.', 'elementor-pro' ), 'https://help.mailerlite.com/article/show/35040-where-can-i-find-the-api-key' ),
					],
				],
				'validate_api_data' => [
					'field_args' => [
