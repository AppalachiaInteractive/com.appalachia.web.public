...
var _indexFavoriteNoResult = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index-favorite-no-result */ "../core/app/modules/kit-library/assets/js/pages/index/index-favorite-no-result.js"));
...
function App() {
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    noResultComponent: _indexFavoriteNoResult.default
...
function FilterIndicationText(props) {
  var selectedTaxonomies = (0, _react.useMemo)(function () {
    return (0, _values.default)(props.queryParams.taxonomies).reduce(function (current, groupedTaxonomies) {
  ...
  var isFilterActive = (0, _react.useMemo)(function () {
    return props.queryParams.search || !!selectedTaxonomies.length;
  }, [props.queryParams]);
  ...
  }, (0, _i18n.sprintf)(__('Showing %s Results', 'elementor'), props.resultCount), ' ', props.queryParams.search && (0, _i18n.sprintf)(__('For: "%s"', 'elementor'), props.queryParams.search), ' ', selectedTaxonomies.length > 0 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, __('In', 'elementor'), ' ', selectedTaxonomies.map(function (taxonomy) {
...
/***/ "../core/app/modules/kit-library/assets/js/pages/index/index-favorite-no-result.js":
/*!*****************************************************************************************!*\
  !*** ../core/app/modules/kit-library/assets/js/pages/index/index-favorite-no-result.js ***!
  \*****************************************************************************************/
/*! unknown exports (runtime-defined) */
...
exports.default = IndexFavoriteNoResult;
...
function IndexFavoriteNoResult(props) {
  return /*#__PURE__*/_react.default.createElement(_appUi.Grid, {
    container: true,
    alignItems: "center",
    justify: "center",
  ...
  }, __('No favorites here yet...', 'elementor')), /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    variant: "xl",
    className: "e-kit-library__not-results-description"
  }, __('Use the heart icon to save kits that inspire you. You\'ll be able to find them here', 'elementor'), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement(_appUi.Button, {
...
function IndexNoResults(props) {
  return /*#__PURE__*/_react.default.createElement(_appUi.Grid, {
    ...
    variant: "xl",
    className: "e-kit-library__not-results-description"
  }, __('Try retyping another keyword or explore the most popular kits bellow.', 'elementor'), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    text: __('Continue Browsing', 'elementor'),
    color: "link",
    onClick: props.clearFilter
  })));
...
function Index(props) {
  ...
  var NoResultComponent = props.noResultComponent;
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_appUi.SearchInput, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_appUi.SortSelect, {
    options: [{
    ...
    data: data
  }), isSuccess && 0 === data.length && /*#__PURE__*/_react.default.createElement(NoResultComponent, {
    clearFilter: clearQueryParams
  })))));
}
...
Index.defaultProps = {
  noResultComponent: _indexNoResults.default
};
...
//# sourceMappingURL=d60824db7fe2a3a6044a.bundle.js.map